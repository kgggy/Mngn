                            ...
                            <div class="astino-pr-form card-body">
                                <form>
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="훈련서비스">
                                    </div>
                                    <div class="form-group d-flex align-items-center">
                                    ...
                                    <div class="form-group d-flex align-items-center">
                                        ...
                                        <textarea class="form-control" id="formGroupExampleInput5" placeholder="훈련서비스는 사용자의 자택에서 이루어진다. 사용자와 반려동물이 함께 교육 받는 것을 원칙으로 한다."></textarea>
                                    </div>
                    ...
                    <div class="col-sm">
                        <nav aria-label="Bootstrap Pagination Example">
                            <ul class="pagination mb-0">
                                <li class="page-item">
                                    <a class="page-link" href="serviceList.do"><span class="ml-1 d-none d-xl-inline-block">Previous</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
