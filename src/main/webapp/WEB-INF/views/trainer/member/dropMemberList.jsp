                ...
                <nav class="u-sidebar-nav">
                    <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                        ...
                        <li class="u-sidebar-nav-menu__item">
                            <a class="u-sidebar-nav-menu__link" href="home.do">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" onclick="location.href='dropMemSelectList.do'" class="btn btn-outline-danger btn-sm">상세보기</button>
                                                </td>
                                            </tr>
                    ...
                    <div class="col-sm">
                        <nav aria-label="Bootstrap Pagination Example">
                            <ul class="pagination mb-0">
                                <li class="page-item">
                                    <a class="page-link" href="memberList.do"><span class="ml-1 d-none d-xl-inline-block">이전으로</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
