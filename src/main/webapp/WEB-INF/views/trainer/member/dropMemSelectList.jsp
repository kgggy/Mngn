                    ...
                    <ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
                        ...
                        <li class="u-sidebar-nav-menu__item clearfix">
                            ...
                            <ul id="baseUI" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level text-center" style="display: none;">
                                <li class="u-sidebar-nav-menu__item">
                                    <a class="u-sidebar-nav-menu__link" href="boardSelectList.do">
        ...
        <div class="u-content">
            <div class="u-body">
                <header class="astino-pr-form-header">
                    <h2 class="h1 card-header-title">탈퇴회원 상세 정보</h2>
                </header>
                <div class="row">
                    <!-- Current Projects -->
                        ...
                        <div class="card h-100">
                            <div class="astino-pr-form card-body">
                                <form>
                                    ...
                                    <a href="dropMemberList.do" class="btn btn-danger btn-large float-right">
                                        확인
                                    </a>
                                </form>
                            </div>
                    ...
                    <div class="col-sm">
                        <nav aria-label="Bootstrap Pagination Example">
                            <ul class="pagination mb-0">
                                <li class="page-item">
                                    <a class="page-link" href="dropMemberList.do"><span class="ml-1 d-none d-xl-inline-block">이전으로</span></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
