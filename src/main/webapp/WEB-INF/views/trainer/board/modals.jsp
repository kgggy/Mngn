...
<html lang="en" class="no-js">
	<!-- Head -->
	<head>
		<title>Colors | Stream - Dashboard UI Kit</title>
					...
					<nav class="u-sidebar-nav">
						<ul class="u-sidebar-nav-menu u-sidebar-nav-menu--top-level">
							...
							<li class="u-sidebar-nav-menu__item u-sidebar-nav--opened">
								...
								<ul id="baseUI" class="u-sidebar-nav-menu u-sidebar-nav-menu--second-level" style="display: block;">
									<li class="u-sidebar-nav-menu__item">
									...
									<li class="u-sidebar-nav-menu__item">
										<a class="u-sidebar-nav-menu__link active" href="./ui-colors.html">
