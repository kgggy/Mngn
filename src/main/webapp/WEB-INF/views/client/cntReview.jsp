...
<body>
	...
	<div class="main">
		...
		<!--디폴트 메뉴-->
		<label id="tab1" for="tab1">서비스 이용 내역 조회</label> <input id="tab2" type="radio" name="tabs"> <label id="tab2"
			for="tab2">내가
			작성한 후기</label>
		<section id="content1">
				...
				<table class="table table-striped table-hover">
					...
					<tbody align="center">
						<c:forEach items="${serviceUses }" var="serUse">
							<input type="hidden" id="client_id" name="client_id" value="${serUse.client_id2 }">
							<tr>
								...
								<td>
									<c:if test="${serUse.reviewyn == '0'}">
										<a href="#" class="btn btn-sm manage" data-reserno="${serUse. reser_no}"
											data-toggle="modal" data-target="#reviewModal">후기 작성</a>
									</c:if>
									<c:if test="${serUse.reviewyn > '0'}">
						...
						<c:forEach items="${myReviews }" var="myReview">
							<tr data-status="active">
								...
								<td><a href="#" class="btn btn-sm manage" data-toggle="modal"
										data-target="#reviewUpdate">수정</a>&nbsp;&nbsp;
									<a href="javascript:window.alert('삭제하시겠습니까?')" class="btn btn-sm manage">삭제</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
					...
					<form role="form" id="signform" name="signform" method="post">
						...
						<div class="modalpopup" align="center">
							<div class="star-rating">
								...
								<label style="font-size: 30pt; width: 40px; height: 40px" for="3-stars"
									class="star">&#9733;</label> <input type="radio" id="2-stars" name="star_rate"
									value="2" /> <label style="font-size: 30pt; width: 40px; height: 40px" for="2-stars"
									class="star">&#9733;</label> <input type="radio" id="1-star" name="star_rate"
									value="1" /> <label for="1-star" class="star"
									style="font-size: 30pt; width: 40px; height: 40px">&#9733;</label>
							</div>
						</div>
						<br> <br>
				...
				<div class="modal-footer">
					...
					<button type="button" id="uploadBtn" class="btn btn-danger" data-dismiss="modal">취소</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" id="signform1" name="signform1" method="post">
						...
						<textarea id="eml_cnt"
							style="width: 100%; margin-top: 0px; margin-bottom: 0px; height: 286px; resize: none;"
							name="eml_cnt" rows="10" class="form-control" placeholder="${review.cntn }"></textarea>
						<br> <br>
						<img id="camera_img" src="img/camera.png" style="height: 90px; width: 130px">
				...
				<div class="modal-footer">
					<button type="button" id="okbutton" class="btn btn-success" data-dismiss="modal">수정</button>
